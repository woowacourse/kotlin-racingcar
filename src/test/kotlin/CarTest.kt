...
class CarTest {
    ...
    fun 생성자_위치_명시하지_않으면_초기위치_0이다() {
        assertThat(Car.from("test").getPosition()).isEqualTo(0)
    }
